...
@interface HWTotalPriceRangeSlider : UIControl
...
@property(nonatomic,strong)NSString* sliderType;//1代表面积选择器0代表总价选择器
...
@property(retain, nonatomic) NSString*lowLastValueStr;
@property(retain, nonatomic) NSString*uperLastValueStr;
