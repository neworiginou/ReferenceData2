...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        self.textLabel.font = [UIFont fontWithName:FONTNAME size:12];
        ...
        _timestampLabel.font = [UIFont fontWithName:FONTNAME size:12];
        _timestampLabel.textColor = TITLE_COLOR_99;
        _timestampLabel.frame = CGRectMake(0.0f, 10, kScreenWidth, 18);
        ...
        messageBackgroundView.image = [[UIImage imageNamed:@"sall_green"] resizableImageWithCapInsets:UIEdgeInsetsMake(35, 30, 10, 60)];
...
- (void)layoutSubviews {
    ...
    messageBackgroundView.frame = CGRectMake(textLabelFrame.origin.x - 8, textLabelFrame.origin.y - 2 - 5, labelSize.width + 16 + 10, labelSize.height + 21);
    _timestampLabel.frame = CGRectMake(0.0f, 10, kScreenWidth, 18);
