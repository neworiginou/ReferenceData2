...
{
//    actionSheet = [[MTCustomActionSheet alloc] initWithFrame:CGRectZero andImageArr:[NSArray arrayWithObjects:@"share_weixin",@"share_friend",@"share_sms", nil] nameArray:[NSArray arrayWithObjects:@"微信",@"朋友圈",@"短信",nil] orientation:0];
...
- (void)clickSMS
{
    ...
    [[UMSocialDataService defaultDataService] postSNSWithTypes:@[UMShareToSms] content:[NSString stringWithFormat:@"%@,%@",shareContent,self.shareUrl] image:nil location:nil urlResource:nil presentedController:self.presentController completion:^(UMSocialResponseEntity *response) {
