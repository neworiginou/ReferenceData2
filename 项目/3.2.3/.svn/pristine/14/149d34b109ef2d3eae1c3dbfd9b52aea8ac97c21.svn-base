...
//            NSLog(@"the SubLocality is %@",[dic objectForKey:@"SubLocality"]);
            ...
            [locationBtn setFrame:CGRectMake(kScreenWidth / 2.0f - locationBtn.frame.size.width / 2.0f - 5, mapViewTemp.frame.size.height / 2 - 44 - 30 - 10, locationBtn.frame.size.width + 10, 30)];
