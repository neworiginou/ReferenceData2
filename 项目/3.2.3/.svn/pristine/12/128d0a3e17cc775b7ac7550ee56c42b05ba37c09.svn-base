...
#import "HWTotalPriceRangeSlider.h"

@interface HWTotalPriceRangeSlider ()
{
...
@implementation HWTotalPriceRangeSlider
    ...
    if(_lowerHandle.highlighted)
    {
        ...
        if(!_upperHandle.highlighted || newValue<_lowerValue)
        {
            ...
            if ((newValue-[lowLastValueStr floatValue]) < 0)
            {
                ...
                {
                    [self setLowerValue:100 animated:_stepValueContinuously ? YES : NO];
                }
                ...
                else if(newValue >= 300 && newValue <500)
                {
                    [self setLowerValue:300 animated:_stepValueContinuously ? YES : NO];
                }
                else if(newValue >= 500 && newValue < 1000)
                {
                    [self setLowerValue:500 animated:_stepValueContinuously ? YES : NO];
                }
                else if(newValue >=1000 && newValue<1010)
                {
                    [self setLowerValue:1000 animated:_stepValueContinuously ? YES : NO];
                }
                else
                {
                    [self setLowerValue:1010 animated:_stepValueContinuously ? YES : NO];
    ...
    if(_upperHandle.highlighted )
    {
        ...
        if(!_lowerHandle.highlighted || newValue>_upperValue)
        {
            ...
            if ((newValue-[uperLastValueStr floatValue]) < 0) {
                if (newValue < 100 ) {
                    [self setUpperValue:0 animated:_stepValueContinuously ? YES : NO];
                }
                else if (newValue >=100 && newValue<150)
                {
                    [self setUpperValue:100 animated:_stepValueContinuously ? YES : NO];
                }
                else if(newValue >=150 && newValue < 200)
                {
                ...
                {
                    [self setUpperValue:500 animated:_stepValueContinuously ? YES : NO];
                }
                else if(newValue >=1000 && newValue <1010)
                {
                     [self setUpperValue:1000 animated:_stepValueContinuously ? YES : NO];
                }
                else
                {
                    [self setUpperValue:1010 animated:_stepValueContinuously ? YES : NO];
                }
