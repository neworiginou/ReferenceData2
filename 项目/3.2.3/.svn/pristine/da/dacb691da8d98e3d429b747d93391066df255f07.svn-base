...
- (void)viewDidLoad
{
    ...
    self.baseTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, CONTENT_HEIGHT) style:UITableViewStylePlain];
    ...
    slimeView.slime.bodyColor = CD_MainColor;
    ...
    [self.baseTableView addSubview:slimeView];
...
- (void)showNewEmpty:(NSString *)msg{
    ...
    UIView *view = [[UIView alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth, CONTENT_HEIGHT)];
    view.backgroundColor = [UIColor clearColor];
    view.tag = kNewTag;
...
- (void)setFooterView
{
    ...
    if (_refreshFooterView && [_refreshFooterView superview] && endLabel)
	{
        // reset position
        ...
        endLabel.frame = CGRectMake(0, height, self.baseTableView.frame.size.width, 50);
    }
    else
	{
        ...
        endLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, height, self.baseTableView.frame.size.width, 50)];
...
//        endLabel.text = @"The End";
        ...
        endLabel.hidden = YES;
        [baseTableView addSubview:endLabel];
